    ...
    <section class="space-y-6">
      <div class="flex flex-col gap-4 rounded-3xl border border-slate-200 bg-white/70 p-6 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h2 class="mt-2 text-3xl font-semibold text-slate-950">{{ i18n.t('trade.edit.title') }}</h2>
          <p class="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
            {{ i18n.t('trade.edit.description') }}
          </p>
        </div>
        ...
        <form
          ...
          <div class="flex justify-end lg:col-span-2">
            <button
              ...
              {{ isSubmitting() ? i18n.t('trade.edit.submitting') : i18n.t('trade.edit.submit') }}
            </button>
          </div>
        </form>
      }
